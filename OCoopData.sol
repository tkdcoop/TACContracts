// Coop Data contract for deployment on optimism
...
contract CoopData is AccessControl {
    ...
    address public EventsContract = 0xABa8ace37f301E7a3A3FaD44682C8Ec8DC2BD18A;
    ...
    function verifyTraining(uint64 id) public {
        ...
        //Award bonus TAC
        TAC.awardTrainingTAC(msg.sender, allTrainings[id].referee);
    }
}
